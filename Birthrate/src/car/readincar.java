...
public class readincar {
     public static void main(String[] args) {
        Path pathToTargetFile = Paths.get("car.txt");
 List<String> lines;
        try {
            lines = Files.readAllLines(pathToTargetFile, Charset.forName("UTF-8"));//read all the lines that are 
            String output = "";
